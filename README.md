...
agents/      -- Feature-subset agents + evaluation (Area 1)
search/      -- Alpha-beta engine (Area 1)
simulation/  -- Game simulation + random agent (Area 2)
tournament/  -- Round-robin, leaderboard, I/O (Area 2)
analysis/    -- Marginals, synergy, interpretation (Area 2)
reports/     -- Markdown report generation (Area 2)
